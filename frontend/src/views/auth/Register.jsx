                    ...
                    <div className="col-lg-5 col-md-8 py-8 py-xl-0">
                        <div className="card shadow">
                            <div className="card-body p-6">
                                <div className="mb-4">
                                    <h1 className="mb-1 fw-bold">Inscribirse</h1>
                                    <span>
                                ...
                                <form className="needs-validation" onSubmit={handleRegister}>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="text" onChange={handleBioDataChange} value={bioData.full_name} id="full_name" className="form-control" name="full_name" placeholder="Example: Angel Jimenez" required="" />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="email" className="form-label">
                                            Correo Electronico
                                        ...
                                        <div className="d-grid">
                                            <button className="btn btn-primary w-100" type="submit" disabled={isLoading}>
                                                {isLoading ? (
                                                    ...
                                                    <>
                                                        <span className="mr-2">Inscribirse </span>
