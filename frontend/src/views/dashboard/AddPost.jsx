...
function AddPost() {
    ...
    const handleCreatePost = async (e) => {
        ...
        try {
            ...
            Swal.fire({
                icon: "success",
                title: "Post creada exitosamente.",
            });
            navigate("/posts/");
        } catch (error) {
            console.log(error);
                                            ...
                                            <div className="offset-lg-1 col-lg-10 col-md-12 col-12">
                                                <div className="d-lg-flex align-items-center justify-content-between">
                                                    <div className="mb-4 mb-lg-0">
                                                        <h1 className="text-white mb-1">Crear Blog Post</h1>
                                                        <p className="mb-0 text-white lead">Utilice el constructor de artículos a continuación para escribir su artículo..</p>
                                                    </div>
                                                    <div>
                                                        <Link to="/" className="btn" style={{ backgroundColor: "white" }}>
                                                            {" "}
                                                            <i className="fas fa-arrow-left"></i> Volver a los Posts
                                                        </Link>
                                ...
                                <form onSubmit={handleCreatePost} className="pb-8 mt-5">
                                    <div className="card mb-3">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <small>Escribe un título de publicación de 60 caracteres.</small>
                                            </div>
                                            <div className="mb-3">
                                                <label className="form-label">Categoria del Post</label>
                                                ...
                                                <small>Ayude a las personas a encontrar sus publicaciones eligiendo categorías que representen su publicación.</small>
                                            </div>

                                            <div className="mb-3">
                                                <label className="form-label">Descripcion del Post</label>
                                                <textarea onChange={handleCreatePostChange} name="description" className="form-control" id="" cols="30" rows="10"></textarea>
                                                <small>Un breve resumen de tus publicaciones.</small>
                                            </div>
                                            <label className="form-label">Etiquetas/Tags</label>
                                            <input onChange={handleCreatePostChange} name="tags" className="form-control" type="text" placeholder="Salud, Medicina, Fitness" />
                                    ...
                                    {isLoading === true ? (
                                        ...
                                        <button className="btn btn-lg btn-success w-100 mt-2" type="submit">
                                            Crear Post <i className="fas fa-check-circle"></i>
                                        </button>
                                    )}
                                </form>
                            </>
