...
function EditPost() {
    ...
    const handleCreatePost = async (e) => {
        ...
        try {
            ...
            Swal.fire({
                icon: "success",
                title: "Post actualizada exitosamente.",
            });
            navigate("/posts/");
        } catch (error) {
            console.log(error);
                                            ...
                                            <div className="offset-lg-1 col-lg-10 col-md-12 col-12">
                                                <div className="d-lg-flex align-items-center justify-content-between">
                                                    <div className="mb-4 mb-lg-0">
                                                        <h1 className="text-white mb-1">Actualizar Blog Post</h1>
                                                        <p className="mb-0 text-white lead">Utilice el constructor de artículos a continuación para actualizar su artículo..</p>
                                                    </div>
                                                    <div>
                                    ...
                                    <div className="card mb-3">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <small>Ayude a las personas a encontrar sus publicaciones eligiendo categorías que las representen.</small>
                                            </div>
                                        </div>
                                    </div>
                                    {isLoading === true ? (
                                        ...
                                        <button className="btn btn-lg btn-success w-100 mt-2" type="submit">
                                            Actualizar Post <i className="fas fa-check-circle"></i>
                                        </button>
                                    )}
                                </form>
                            </>
