            ...
            <nav className="navbar navbar-expand-lg">
                <div className="container">
                    <Link className="navbar-brand" to="/">
                        <img className="navbar-brand-item dark-mode-item" src="https://i.postimg.cc/gkG9PwGm/cooltext480549157729853.gif" style={{ width: "200px" }} alt="logo" />
                    </Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <ul className="navbar-nav navbar-nav-scroll ms-auto">
                            ...
                            {/*<li className="nav-item dropdown">
                                <Link className="nav-link active" to="Category.jsx">
                                    Categoria
                                </Link>
                            </li>*/}
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="pagesMenu">
                                    <li>
                                        <Link className="dropdown-item" to="/about/">
                                            <i className="bi bi-person-lines-fill"></i> Sobre N.
                                        </Link>
                                    </li>
                                    <li>
                                ...
                                <ul className="dropdown-menu" aria-labelledby="pagesMenu">
                                    ...
                                    <li>
                                        <Link className="dropdown-item" to="/add-post/">
                                            <i className="fas fa-plus-circle"></i> A+ Post
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className="dropdown-item" to="/comments/">
                                            <i className="bi bi-chat-left-quote-fill"></i> Comentarios
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className="dropdown-item" to="/notifications/">
                                            <i className="fas fa-bell"></i> Notifiaciones
                                        </Link>
                                    </li>
                                    <li>
                                ...
                                {isLoggedIn() ? (
                                    <>
                                        ...
                                        <Link to={"/logout/"} className="btn btn-danger ms-2" href="dashboard.html">
                                            Cerrar Sesion <i className="fas fa-sign-out-alt"></i>
                                        </Link>
                                    </>
                                ) : (
                                    <>
                                        ...
                                        <Link to={"/login/"} className="btn btn-success ms-2" href="dashboard.html">
                                            Iniciar Sesion <i className="fas fa-sign-in-alt"></i>
                                        </Link>
                                    </>
                                )}
                            </li>
